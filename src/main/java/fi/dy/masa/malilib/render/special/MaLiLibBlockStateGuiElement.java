...
{
    public MaLiLibBlockStateGuiElement(BlockState state, Quaternionf rotation, int x0, int y0, int size, float scale, float yOffset, @Nullable ScreenRect scissorArea)
    {
        this(state,
             rotation,
             x0, y0,
