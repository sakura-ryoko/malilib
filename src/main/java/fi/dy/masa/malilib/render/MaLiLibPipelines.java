...
public class MaLiLibPipelines
{
    ...
    public static ShaderPipeline POSITION_LEQUAL_DEPTH;
    public static ShaderPipeline POSITION_EQUAL_DEPTH;
    ...
    public static ShaderPipeline POSITION_COLOR_LEQUAL_DEPTH;
    public static ShaderPipeline POSITION_COLOR_EQUAL_DEPTH;
    ...
    public static ShaderPipeline POSITION_TEX_LEQUAL_DEPTH;
    public static ShaderPipeline POSITION_TEX_EQUAL_DEPTH;
    ...
    public static ShaderPipeline POSITION_TEX_COLOR_LEQUAL_DEPTH;
    public static ShaderPipeline POSITION_TEX_COLOR_EQUAL_DEPTH;
...
//    public static ShaderPipeline LINES_LEQUAL_DEPTH;
//    public static ShaderPipeline LINES_EQUAL_DEPTH;
...
//    public static ShaderPipeline DEBUG_LINES_LEQUAL_DEPTH;
//    public static ShaderPipeline DEBUG_LINES_EQUAL_DEPTH;
