		...
		try
		{
			...
			if (state != null && renderer.shouldUseRenderContext())
			{
				...
				else
				{
					...
					if (renderer.shouldUseLineWidth())
					{
						ctx.lineWidth(state.lineWidth());
						useLineWidth = true;
					}
					if (renderer.shouldUseLightmap())
					{
						useLightmapTex = true;
					}
					...
					try
					{
						ctx.drawPost(null, useColor, useLineWidth, useOffset, useLightmapTex);
					}
