...
public class MaLiLibBlockTargetingOverlayEdgesRenderState extends AbstractMaLiLibBlockTargetingOverlayRenderState
{
	public MaLiLibBlockTargetingOverlayEdgesRenderState(BlockPos pos,
	                                                    Vec3 camPos,
