...
//            RenderUtils.blend(true);
            ...
            for (int i = 0; i < this.labels.size(); ++i)
            {
                ...
                if (this.centered)
                {
                    this.drawCenteredStringWithShadow(drawContext, this.layer, this.x + this.width / 2, yTextStart + i * fontHeight, this.textColor, text);
                }
                else
                {
                    this.drawStringWithShadow(drawContext, this.layer, this.x, yTextStart + i * fontHeight, this.textColor, text);
                }
            }
        }
    }
