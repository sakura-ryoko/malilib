...
public class WidgetListBlockStateListEditEntry extends WidgetConfigOptionBase<BlockState>
{
	...
	{
		return BlockArgumentParser.stringifyBlockState(Objects.requireNonNullElseGet(value, Blocks.AIR::getDefaultState));
	}
	...
	protected ButtonGeneric createResetButton(int x, int y, GuiTextFieldGeneric textField)
	{
		...
		resetButton.setEnabled(!textField.getText().equals(this.defaultValueString));
	...
	public void applyNewValueToConfig()
	{
		...
		if (this.textField != null && !this.textField.getTextField().getText().isEmpty())
		{
			final String textValue = this.textField.getTextField().getText();
			...
			implements IBlockStateConsumer
	{
		...
		public void setState(BlockState state)
		{
			...
			{
				this.parent.textField.getTextField().setText(stateToString(state));
			}
			...
			implements IButtonActionListener
	{
		...
		public void actionPerformedWithButton(ButtonBase button, int mouseButton)
		{
			if (this.parent.textField != null)
			{
				this.parent.textField.getTextField().setText(this.parent.defaultValueString);
				this.parent.parent.applyPendingModifications();
				this.buttonReset.setEnabled(!this.parent.textField.getTextField().getText().equals(this.parent.defaultValueString));
			}
