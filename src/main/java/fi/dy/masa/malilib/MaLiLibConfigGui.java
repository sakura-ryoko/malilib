...
public class MaLiLibConfigGui extends GuiConfigsBase implements IConfigGuiAllTab
{
    ...
    private int createButton(int x, int y, int width, ConfigGuiTab tab)
    {
        ...
        this.addButton(button, new ButtonListener(this, tab));
    ...
    private record ButtonListener(MaLiLibConfigGui parent, ConfigGuiTab tab) implements IButtonActionListener
    {
        @Override
