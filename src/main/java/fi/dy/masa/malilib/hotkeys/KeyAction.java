...
public enum KeyAction implements IConfigOptionListEntry, StringRepresentable
{
    ...
    public static final StringRepresentable.EnumCodec<KeyAction> CODEC = StringRepresentable.fromEnum(KeyAction::values);
    public static final StreamCodec<ByteBuf, KeyAction> PACKET_CODEC = ByteBufCodecs.STRING_UTF8.map(KeyAction::fromStringStatic, KeyAction::getSerializedName);
