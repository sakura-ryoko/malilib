...
public class LayerRange
{
    ...
    public static final PacketCodec<@NotNull ByteBuf, @NotNull LayerRange> PACKET_CODEC = new PacketCodec<>()
    {
	    @Override
	    public void encode(ByteBuf buf, LayerRange value)
	    {
            ...
            PacketCodecs.INTEGER.encode(buf, value.playerFollowOffset);
            PacketCodecs.BOOLEAN.encode(buf, value.hotkeyRangeMin);
            PacketCodecs.BOOLEAN.encode(buf, value.hotkeyRangeMax);
            PacketCodecs.BOOLEAN.encode(buf, value.followPlayer);
	    }
	    ...
	    public LayerRange decode(ByteBuf buf)
	    {
		    return new LayerRange(
                    ...
                    Direction.Axis.byName(PacketCodecs.STRING.decode(buf)),
    ...
    public boolean isPositionWithinRange(net.minecraft.util.math.BlockPos pos)
    {
        return this.isPositionWithinRange(pos.getX(), pos.getY(), pos.getZ());
    }
    ...
    public boolean isPositionAtRenderEdgeOnSide(net.minecraft.util.math.BlockPos pos, net.minecraft.util.math.Direction side)
    {
    ...
    public boolean intersectsBox(net.minecraft.util.math.BlockPos pos1, net.minecraft.util.math.BlockPos pos2)
    {
        net.minecraft.util.math.BlockPos posMin = PositionUtils.getMinCorner(pos1, pos2);
        net.minecraft.util.math.BlockPos posMax = PositionUtils.getMaxCorner(pos1, pos2);
        return this.intersectsBox(posMin.getX(), posMin.getY(), posMin.getZ(), posMax.getX(), posMax.getY(), posMax.getZ());
    }
     ...
     */
    @Nullable
    public IntBoundingBox getClampedArea(net.minecraft.util.math.BlockPos posMin, net.minecraft.util.math.BlockPos posMax)
    {
    ...
    {
        this.layerMode = LayerMode.fromStringStatic(fi.dy.masa.malilib.util.JsonUtils.getString(obj, "mode"));
        this.axis = Direction.Axis.byName(fi.dy.masa.malilib.util.JsonUtils.getStringOrDefault(obj, "axis", "y"));

        if (this.axis == null) { this.axis = Direction.Axis.Y; }

        this.followPlayer = fi.dy.masa.malilib.util.JsonUtils.getBoolean(obj, "follow_player");
        this.layerSingle = fi.dy.masa.malilib.util.JsonUtils.getInteger(obj, "layer_single");
        this.layerAbove = fi.dy.masa.malilib.util.JsonUtils.getInteger(obj, "layer_above");
        this.layerBelow = fi.dy.masa.malilib.util.JsonUtils.getInteger(obj, "layer_below");
        this.layerRangeMin = fi.dy.masa.malilib.util.JsonUtils.getInteger(obj, "layer_range_min");
        this.layerRangeMax = fi.dy.masa.malilib.util.JsonUtils.getInteger(obj, "layer_range_max");
        this.playerFollowOffset = fi.dy.masa.malilib.util.JsonUtils.getInteger(obj, "player_follow_offset");
        this.hotkeyRangeMin = fi.dy.masa.malilib.util.JsonUtils.getBoolean(obj, "hotkey_range_min");
        this.hotkeyRangeMax = fi.dy.masa.malilib.util.JsonUtils.getBoolean(obj, "hotkey_range_max");
    }
