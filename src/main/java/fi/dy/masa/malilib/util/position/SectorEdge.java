...
public enum SectorEdge implements StringIdentifiable
{
    START_ANGLE(false),
    END_ANGLE(false),
    INNER_RING(true),
    ...
    public static final StringIdentifiable.EnumCodec<@NotNull SectorEdge> CODEC = StringIdentifiable.createCodec(SectorEdge::values);
    public static final PacketCodec<@NotNull ByteBuf, @NotNull SectorEdge> PACKET_CODEC = PacketCodecs.STRING.xmap(SectorEdge::fromStringStatic, SectorEdge::asString);
