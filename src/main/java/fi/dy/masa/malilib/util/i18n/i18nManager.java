...
public class i18nManager
{
	...
	public Text translateAsText(String key, Object... args)
	{
		this.ensureLang();

		if (this.hasTranslation(key))
		{
			return Text.of(this.translate(key, args));
		}
		else
		{
			return Text.literal(key)
							.styled((style) ->
									        style.withColor(Formatting.RED)
									             .withHoverEvent(new HoverEvent.ShowText(Text.literal("Missing translation: " + key)))
					);
		}
	}
