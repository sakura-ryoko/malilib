...
public enum ActiveMode implements IConfigOptionListEntry, StringRepresentable
{
    ...
    public static final StringRepresentable.EnumCodec<ActiveMode> CODEC = StringRepresentable.fromEnum(ActiveMode::values);
    public static final StreamCodec<ByteBuf, ActiveMode> PACKET_CODEC = ByteBufCodecs.STRING_UTF8.map(ActiveMode::fromStringStatic, ActiveMode::getSerializedName);
