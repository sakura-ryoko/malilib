...
public enum Schema implements IEnumCodecProvider
{
    ...
    public static final EnumCodec<@NotNull Schema> CODEC = StringIdentifiable.createCodec(Schema::sorted);
    public static final PacketCodec<@NotNull ByteBuf, @NotNull Schema> PACKET_CODEC = new PacketCodec<>()
    {
        @Override
