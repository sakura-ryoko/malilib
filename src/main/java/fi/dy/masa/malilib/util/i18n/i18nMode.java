...
public enum i18nMode implements IConfigOptionListEntry, StringIdentifiable
{
    ...
    public static final StringIdentifiable.EnumCodec<@NotNull i18nMode> CODEC = StringIdentifiable.createCodec(i18nMode::values);
    public static final PacketCodec<@NotNull ByteBuf, @NotNull i18nMode> PACKET_CODEC = PacketCodecs.STRING.xmap(i18nMode::fromStringStatic, i18nMode::asString);
