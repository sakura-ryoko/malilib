...
public enum BlockMirror implements IConfigOptionListEntry, StringRepresentable
{
    ...
    public static final StringRepresentable.EnumCodec<BlockMirror> CODEC = StringRepresentable.fromEnum(BlockMirror::values);
    ...
    public static final StreamCodec<ByteBuf, BlockMirror> PACKET_CODEC = ByteBufCodecs.idMapper(INDEX_TO_VALUE, BlockMirror::getIndex);
