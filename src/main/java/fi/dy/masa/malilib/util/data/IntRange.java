...
public class IntRange
{
    ...
    public static final PacketCodec<@NotNull ByteBuf, @NotNull IntRange> PACKET_CODEC = new PacketCodec<>()
    {
        @Override
        public void encode(@Nonnull ByteBuf buf, IntRange value)
        {
            PacketCodecs.INTEGER.encode(buf, value.first);
            PacketCodecs.INTEGER.encode(buf, value.length);
        }
