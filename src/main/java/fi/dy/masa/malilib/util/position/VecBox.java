...
/**
 * Equivalent of the Vanilla {@link Box}
 */
public class VecBox
{
	...
	public static final PacketCodec<@NotNull ByteBuf, @NotNull VecBox> PACKET_CODEC = new PacketCodec<>()
	{
		@Override
	...
	public static VecBox of(final net.minecraft.util.math.Vec3d min, final net.minecraft.util.math.Vec3d max)
	{
	...
	public static VecBox of(final net.minecraft.util.math.BlockPos p0, final net.minecraft.util.math.BlockPos p1)
	{
		return new VecBox(
				MathUtils.min(p0.getX(), p1.getX()),
				MathUtils.min(p0.getY(), p1.getY()),
	...
	public static VecBox of(IntBoundingBox bb)
	{
		...
		{
			pos1 = BlockPos.of(pos1.mutableCopy().setY(pos1.getY() - 1).toImmutable());
		}
		else if (pos2.getY() < pos1.getY())
		{
			pos2 = BlockPos.of(pos2.mutableCopy().setY(pos2.getY() - 1).toImmutable());
		}

		return VecBox.of(pos1, pos2);
	}

	public static VecBox of(Box bb)
	{
