...
public enum BlockRotation implements IConfigOptionListEntry, StringRepresentable
{
    ...
    public static final StringRepresentable.EnumCodec<BlockRotation> CODEC = StringRepresentable.fromEnum(BlockRotation::values);
    ...
    public static final StreamCodec<ByteBuf, BlockRotation> PACKET_CODEC = ByteBufCodecs.idMapper(INDEX_TO_VALUE, BlockRotation::getIndex);
