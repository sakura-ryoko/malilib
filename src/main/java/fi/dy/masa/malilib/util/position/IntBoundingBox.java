...
public record IntBoundingBox(int minX, int minY, int minZ, int maxX, int maxY, int maxZ)
{
    ...
    public boolean contains(net.minecraft.util.math.Vec3i pos)
    {
    ...
    public static IntBoundingBox createProper(net.minecraft.util.math.Vec3i pos1, net.minecraft.util.math.Vec3i pos2)
    {
