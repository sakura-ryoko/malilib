...
public class TestInventoryOverlayHandler implements IInventoryOverlayHandler
{
    ...
    public @Nullable InventoryOverlay.Context getTargetInventory(MinecraftClient mc)
    {
        ...
        else if (trace.getType() == HitResult.Type.ENTITY)
        {
            ...
            {
                Pair<Entity, NbtCompound> pair = this.getDataSyncer().requestEntityNbt(world, entity.getId());
    ...
    public @Nullable InventoryOverlay.Context getTargetInventoryFromBlock(World world, BlockPos pos, @Nullable BlockEntity be, NbtCompound nbt)
    {
        ...
        else
        {
            ...
            inv = this.getDataSyncer().getBlockInventory(world, fi.dy.masa.malilib.util.position.BlockPos.of(pos), false);
        }
             ...
             be instanceof EnderChestBlockEntity)
        {
            if (MinecraftClient.getInstance().player != null)
            {
                ...
                if (player != null)
                {
                    ...
                    Pair<Entity, NbtCompound> enderPair = this.getDataSyncer().requestEntityNbt(world, player.getId());
