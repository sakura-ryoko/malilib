...
//        RenderSystem.enableCull();
    ...
    private void drawData(Matrix4f matrix4f, Matrix4f projMatrix)
    {
        if (this.hasData)
        {
            ...
            this.drawInternal(matrix4f, projMatrix, VERTEX_1, GameRenderer::getPositionColorProgram);
            this.drawInternal(matrix4f, projMatrix, VERTEX_2, GameRenderer::getPositionColorProgram);
            this.postRender();
        }
    }
    ...
    private void drawInternal(Matrix4f matrix4f, Matrix4f projMatrix, VertexBuffer vertexBuffer, Supplier<ShaderProgram> shader)
    {
        if (this.hasData)
        {
            // TODO 1.21.3+
