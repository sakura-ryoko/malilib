...
public class TestTextPlateRenderer
{
	...
	private void scanForEntities(MinecraftClient mc)
	{
		...
		if (level != null)
		{
			List<HorseEntity> nearbyHorses = level.getEntitiesByClass(HorseEntity.class, bb, EntityPredicates.VALID_LIVING_ENTITY);
...
//		RenderUtils.drawTextPlate(this.text, x, y, z, scale, delta, TextAlignment.CENTER);
//		RenderUtils.drawTextPlate(this.text, x, y, z, e.getYaw(), e.getPitch(), scale, 0xFFFFFFFF, 0x40000000, false, TextAlignment.CENTER);
