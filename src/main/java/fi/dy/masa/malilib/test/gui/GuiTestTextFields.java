...
public class GuiTestTextFields extends GuiBase
{
	...
	public void initGui()
	{
		...
		this.shortField = new GuiTextFieldGeneric(x, y, this.calcMaxTextFieldWidth(shortLength), height, this.textRenderer);
		this.shortField.setText(this.string3.get());
		...
		this.defaultField = new GuiTextFieldGeneric(x, y, this.calcMaxTextFieldWidth(defaultLength), height, this.textRenderer);
		this.defaultField.setText(this.string4.get());
		...
		this.longField = new GuiTextFieldGeneric(x, y, this.calcMaxTextFieldWidth(longLength), height, this.textRenderer);
		this.longField.setText(this.string5.get());
			...
			implements IButtonActionListener
	{
		...
		public void actionPerformedWithButton(ButtonBase button, int mouseButton)
		{
			...
			else if (this.type() == ButtonType.RESET)
			{
				...
				this.gui().shortField.setText(this.gui().defaultString3);
				this.gui().string4 = () -> this.gui().defaultString4;
				this.gui().defaultField.setText(this.gui().defaultString4);
				this.gui().string5 = () -> this.gui().defaultString5;
				this.gui().longField.setText(this.gui().defaultString5);
			}
		}
	}
	...
	private record ShortTextFieldListener(GuiTestTextFields gui) implements ITextFieldListener<GuiTextFieldGeneric>
	{
		...
		{
			this.gui().string3 = textField::getText;
			return true;
		}
	}
	...
	private record DefaultTextFieldListener(GuiTestTextFields gui) implements ITextFieldListener<GuiTextFieldGeneric>
	{
		...
		public boolean onTextChange(GuiTextFieldGeneric textField)
		{
			this.gui().string4 = textField::getText;
			return true;
		}
	}
	...
	private record LongTextFieldListener(GuiTestTextFields gui) implements ITextFieldListener<GuiTextFieldGeneric>
	{
		...
		public boolean onTextChange(GuiTextFieldGeneric textField)
		{
			this.gui().string5 = textField::getText;
			return true;
		}
	}
}
